...
typedef enum {
	...
	U_GNSS_CFG_VAL_KEY_ITEM_MSGOUT_UBX_RXM_MEAS20_I2C_U1       = 0x643, /**< output rate of the UBX-RXM-MEAS20 message on port I2C per epoch. */
    U_GNSS_CFG_VAL_KEY_ITEM_MSGOUT_UBX_RXM_MEAS20_SPI_U1       = 0x647, /**< output rate of the UBX-RXM-MEAS20 message on port SPI per epoch. */
    U_GNSS_CFG_VAL_KEY_ITEM_MSGOUT_UBX_RXM_MEAS20_UART1_U1     = 0x644, /**< output rate of the UBX-RXM-MEAS20 message on port UART1 per epoch. */
    U_GNSS_CFG_VAL_KEY_ITEM_MSGOUT_UBX_RXM_MEAS50_I2C_U1       = 0x648, /**< output rate of the UBX-RXM-MEAS50 message on port I2C per epoch. */
    U_GNSS_CFG_VAL_KEY_ITEM_MSGOUT_UBX_RXM_MEAS50_SPI_U1       = 0x64C, /**< output rate of the UBX-RXM-MEAS50 message on port SPI per epoch. */
    U_GNSS_CFG_VAL_KEY_ITEM_MSGOUT_UBX_RXM_MEAS50_UART1_U1     = 0x649, /**< output rate of the UBX-RXM-MEAS50 message on port UART1 per epoch. */
...
#define U_GNSS_CFG_VAL_KEY_ID_MSGOUT_UBX_RXM_MEAS20_I2C_U1       0x20910643
#define U_GNSS_CFG_VAL_KEY_ID_MSGOUT_UBX_RXM_MEAS20_SPI_U1       0x20910647
#define U_GNSS_CFG_VAL_KEY_ID_MSGOUT_UBX_RXM_MEAS20_UART1_U1     0x20910644
#define U_GNSS_CFG_VAL_KEY_ID_MSGOUT_UBX_RXM_MEAS50_I2C_U1       0x20910648
#define U_GNSS_CFG_VAL_KEY_ID_MSGOUT_UBX_RXM_MEAS50_SPI_U1       0x2091064c
#define U_GNSS_CFG_VAL_KEY_ID_MSGOUT_UBX_RXM_MEAS50_UART1_U1     0x20910649
